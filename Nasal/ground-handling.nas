...
#Canopy falls away when opening in flight
if(getprop("/sim/model/door-positions/canopy/position-norm")>=0.7 & getprop("/gear/gear[1]/wow")==0){
    setprop("/sim/model/canopy-visible", 0);
}
